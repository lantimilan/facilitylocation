...
\section[UFL and FTFL]{Related Work}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% UFL and its results
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% UFL example
...
\begin{frame}
  \frametitle{Demand Reduction: Implication}
  \begin{itemize}
  \item FTFP to FTFL, 1.7245-approximation
  \item $1 + O(|\sitesset| / Q)$ for $Q = \min_j r_j$, approaches $1$ when $Q$ is large
  \end{itemize}
\end{frame}
...
\section[Summary]{Summary and Open Problems}
...
\begin{frame}
  \frametitle{Q and A about FTFP, Cont.}
  \begin{itemize}
