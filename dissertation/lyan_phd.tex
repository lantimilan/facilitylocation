...
intuition a concrete statement and provide an affirmative
answer to this statement.

Let $R_{\min} = \min_{j\in\clientset} r_j$ be the smallest
demand among all clients $j \in \clientset$. We have the
following
