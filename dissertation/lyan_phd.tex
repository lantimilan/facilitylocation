...
FTFL instance. The solution to this FTFL instance trivially
maps to a solution to that FTFP instance. Moreover, the
...
with the same ratio. On the other hand, as we will show in
Chapter~\ref{ch: lp-rounding}, {\FTFP} can be approximated
with a better ratio of $1.575$. Thus, from the standpoint of
