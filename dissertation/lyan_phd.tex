...
closely related to our FTFP problem. They are: the
Uncapacitated Facility Location problem (UFL), and the
Fault-Tolerant Facility Location problem (FTFL). After
presenting the results of these two problems, we conclude
this chapter with an overview of known results and our work
on the FTFP problem.
