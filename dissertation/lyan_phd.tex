...
and connecting clients to facilities to satisfy their
...
takes into account specific requirements of the application,
and the facility location problems come with a number of
variants. Here are some examples of possible problem
specific requirements.
\begin{itemize}
\item The demands of clients could be $1$ or more, and the
  so-called fault-tolerant requirement would force each unit
  demand of a client connected to a different facility.
\item Each site may be limited to one facility, or may open
  multiple facilities.
