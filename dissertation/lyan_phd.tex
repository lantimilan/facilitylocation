...
In this chapter we present results on primal-dual
algorithms. Primal-dual algorithms do not require solve the
LP explicitly and thus avoid the overhead of calling an
LP-solver. Those algorithms work by making simultaneous
updates to an primal solution, which is integral, and a dual
solution, and eventually arriving at a feasible primal
solution and a feasible dual solution. The cost of the two
solutions are related. It is then possible to compare the
