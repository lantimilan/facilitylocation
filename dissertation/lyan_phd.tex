...
bound on the optimal fractional solution value for the
...
Given that the cost of a solution of the {\UFL} problem
...
and greedy augmentation to balance the two factors. Thus
...
$y_i \leq 1$ is what differentiates {\FTFL} from {\FTFP}.
...
solve the LP as the first step, which can be computationally
...
approaches. Our preliminary results using primal-dual
approaches are given in Chapter~\ref{ch: primal-dual}.
