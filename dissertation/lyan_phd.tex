...
\begin{acknowledgements}
  ...
  Riverside, and for his guidance and patience with my study
  ...
  Kristen in UCR graduate writing center, and Stephanie in
  UCR proofread this thesis and corrected grammar mistakes.
...
\begin{abstract}
  ...
  facilities. We show that the problem is NP-hard and hence
...
open, as those are facilities not too far away. However,
this is in general not possible, or we would have to open
...
work, every client $j$ outside $C'$ needs to be able to
...
\begin{proof}
  ...
  $c$-approximation algorithm for {\UFL}~\footnote{We
    ...
    integral solution for the {\UFL} instance should have
...
number of clients $n=k^{k-1} + k^{k-1} + \ldots + 1 = k^k$,
