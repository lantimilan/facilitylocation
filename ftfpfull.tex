...
PS(\ref{PS:xij}), at each step the algorithm maintains an
...
PS(\ref{PS:yi}) follows from that every time we split a
...
fractional solution $(\barbfx,\barbfy)$ needs to satisfy:
\begin{description}
