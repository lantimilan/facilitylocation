...
provably worse random process, which considers facility in
...
distance to $\nu$, where the average is $\sum_{\mu\in G} \bary_{\mu}
d_{\mu\nu} / \sum_{\mu\in G} \bary_{\mu}$. The process first consider
