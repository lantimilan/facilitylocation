...
Solving the LP(\ref{eqn:fac_primal}), we obtain the
following fractional solution in
Table~\ref{tbl:example_frac}.
\begin{table}[ht]
...
\mu_{21}, \mu_{31},$ and $\mu_{41}$. The neighborhood
...
is given in Table~\ref{tbl:example_partition}. It can be
