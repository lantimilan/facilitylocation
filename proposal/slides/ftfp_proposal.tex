...
\begin{frame}
  ...
  \begin{tikzpicture}[scale=0.5]
    ...
    \node[circle,fill=green!50] (client1) at (6,0) {$r_1=1$};
    \node[circle,fill=green!50] (client2) at (6,3) {$r_2=1$};
    \node[circle,fill=green!50] (client3) at (6,6) {$r_3=1$};
    \node[circle,fill=green!50] (client4) at (6,9) {$r_4=1$};
...
\begin{frame}
  \frametitle{The Clustering Structure}
  \begin{tikzpicture}
    % fac group
