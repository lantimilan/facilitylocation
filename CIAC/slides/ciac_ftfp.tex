...
\begin{frame}
  ...
  \begin{tikzpicture}[scale=0.5]
    \node[fill=blue!50] (fac1) at (0,2) {$3$};
    \node[fill=blue!50] (fac2) at (0,5) {$2$};
    \node[fill=blue!50] (fac3) at (0,8) {$1$};

    \node[below] (faclabel1) at (-.5,1.5) {$f_3=4$};
    \node[below] (faclabel2) at (-.5,4.5) {$f_2=6$};
    \node[below] (faclabel3) at (-.5,7.5) {$f_1=3$};

    \node[circle,fill=green!50] (client1) at (6,0) {$4$};
    \node[circle,fill=green!50] (client2) at (6,3) {$3$};
    \node[circle,fill=green!50] (client3) at (6,6) {$2$};
    \node[circle,fill=green!50] (client4) at (6,9) {$1$};

    \node[right] (demand1) at (6,-1) {$r_4=2$};
    \node[right] (demand2) at (6,2) {$r_3=1$};
    \node[right] (demand3) at (6,5) {$r_2=1$};
    \node[right] (demand4) at (6,8) {$r_1=4$};
    
    \foreach \from/\to in {fac1/client1,fac1/client4,fac2/client2,fac3/client1,fac3/client3,fac3/client4}
    \draw (\from)--(\to);
...
%%% A feasible solution
\begin{frame}
  \frametitle{A Feasible Integral Solution}
  ...
  \end{tikzpicture}
    ...
    Cost is $2f_1 + f_2 + 3f_3 + d_{11} + d_{12} + 2d_{14} + d_{23} + 3d_{31} = 38$.
\end{frame}

\begin{frame}
  \frametitle{An Optimal Integral Solution}
    \begin{tikzpicture}[scale=0.5]
    \node[fill=blue!50,minimum size=1cm] (fac3) at (0,2) {$3$};
...
\begin{frame}
  ...
  \begin{itemize}
    \item The Uncapacitated Facility Location problem (UFL), all
      $r_j=1$.
    \item The Fault-tolerant Facility Location problem (FTFL), each
      site can have at most one facility.
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \begin{tikzpicture}[scale=0.5]
    ...
    \node[right] (demand1) at (6,-1) {$r_1=1$};
    \node[right] (demand2) at (6,2) {$r_2=1$};
    \node[right] (demand3) at (6,5) {$r_3=1$};
    \node[right] (demand4) at (6,8) {$r_4=1$};
...
\begin{frame}
  ...
  \begin{tikzpicture}[scale=0.5]
    ...
    \node[right] (demand1) at (6,-1) {$r_1=2$};
    \node[right] (demand2) at (6,2) {$r_2=1$};
    \node[right] (demand3) at (6,5) {$r_3=1$};
    \node[right] (demand4) at (6,8) {$r_4=2$};
...
\begin{frame}
  ...
  \begin{tikzpicture}[scale=0.5]
    ...
    \node[right] (demand2) at (6,2) {$r_2=1$};
    \node[right] (demand3) at (6,5) {$r_3=1$};
    \node[right] (demand4) at (6,8) {$r_4=4$};
...
\begin{frame}
  ...
  \begin{itemize}
  \item For the UFL problem,
    \begin{itemize}
    \item First $O(1)$-approximation result due to Shmoys, Tardos and
      Aardal.
    \item Best known approximation ratio $1.488$ due to Li, combining
      Byrka's LP-rounding algorithm and Jain, Mahdian and Saberi's
      greedy algorithm.
    \end{itemize}
  \item For the FTFL problem,
    best known approximation ratio $1.7245$ due to Byrka, Srinivasan
    and Swamy, using LP-rounding.
  \end{itemize}
\end{frame}
%%% our results
\begin{frame}
  ...
  \begin{itemize}
  \item An LP-rounding algorithm with approximation ratio $1.575$.
  \item A reduction from FTFP to FTFL.
  \item Our approximation ratio for FTFP matches the best known
    LP-based approximation ratio for UFL.
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \begin{tikzpicture}
    ...
    \draw (8,-2) ellipse (1.6cm and 1cm);
    \node (intinst) at (8,-2) {$\sitesset, \clientset, f_i, d_{ij}$};
    \node (intinst1) at (8,-2.5) {$\dotr_j = r_j - \hatr_j$};
    ...
    \node[above] (prop11) at (5.2,2) {feasible};
    \node[below] (prop12) at (5.2,2) {optimal};
    \node[above] (prop21) at (5.2,-2) {feasible};
    \node[below] (prop22) at (5.2,-2) {optimal};
