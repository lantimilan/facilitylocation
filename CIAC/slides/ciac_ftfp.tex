...
\begin{frame}
  ...
  \begin{tikzpicture}
    %% TODO, label edge with r_j = 1 and each site opens one facility
    ...
    \draw[->,ultra thick,label={$y=x^2$}] (ftfp) -- (ufl);
    \draw[->,ultra thick] (ftfp) -- (ftfl);
  \end{tikzpicture}
  \begin{itemize}
...
\begin{frame}
  ...
  \begin{tabular}{| c | c | c | c |}
    ...
    Li & 2012 & 1.488 & hybrid (best result)\\
    \hline
  \end{tabular}
\end{frame}
